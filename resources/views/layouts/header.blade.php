                ...
                <div class="flex items-center space-x-4 ml-6">
                    ...
                    @else
                        ...
                        <a href="{{ route('google.redirect') }}"
                            class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 text-sm font-medium rounded-lg transition duration-300">
            ...
            <div class="md:hidden flex items-center" x-data="{ mobileOpen: false }">
                ...
                <div x-show="mobileOpen" x-transition:enter="transition ease-out duration-200"
                    ...
                    @else
                        ...
                        <a href="{{ route('google.redirect') }}"
                            class="block px-4 py-2 text-red-600 hover:bg-red-50 font-medium transition duration-200">
                            <svg class="w-4 h-4 inline mr-2" viewBox="0 0 24 24">
                                <path fill="#4285F4"
                                    d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                                <path fill="#34A853"
